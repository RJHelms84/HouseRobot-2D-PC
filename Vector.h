...
#include "game.h"
	...
	//as the clases refer to each other, prototypes here
	class Vector3;
    class Vector2;
    ...
    **/
	...
	public:
		...
		//oprator overload - constructs with copy of other Vector3 values
	...
	{
	public:
		double x, y;							//dimension values
		virtual ~Vector2() {}					//destructor

		//constructors and overloads
		Vector2();								//default
		Vector2(const Vector2& V);				//copies existing Vector2	
		...
		//oprator overload - constructs with copy of other Vector2 values
		//eg Vector2 newVector = otherVector;
		Vector2& operator=(const Vector2& V);

		//manipulation functions
		//set x, y with values or with copy
